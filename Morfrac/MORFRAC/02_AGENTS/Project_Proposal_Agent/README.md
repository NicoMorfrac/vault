...
The agent converts approved project inputs into client-facing proposal drafts and a separate internal review pack. It reports directly to the CEO. Raffa AI and other employee-facing interfaces have no automatic access to confidential proposal, costing, pricing, discount, or supplier information.
