# Google Ads Planner: scoped runtime
...
- Exact agent ID: `34701683-f682-4b2e-98bd-c7bb1ad875f6`.
- Own guidance folder / report source_agent: `Google_Ads_Planner`.
- Candidate source roots (each still requires explicit human source scope): `06_MARKETING/`, `08_PROJECTS/`, `10_REFERENCE/`, `06_MARKETING/Ads/Plan_Reviews/`.
- Approved-plan new internal review roots: `06_MARKETING/Ads/Plan_Reviews`.
