...
- Exact agent ID: `241ddc1c-8854-4aa3-82cb-4f9ddb276523`.
- Own guidance folder / report source_agent: `Assistant`.
- Candidate source roots (each still requires explicit human source scope): `05_BUSINESS/Strategy/`, `05_BUSINESS/Accounting/Reviews/`, `06_MARKETING/`, `08_PROJECTS/`, `10_REFERENCE/`, `05_BUSINESS/Administration/Draft_Reviews/`.
- Approved-plan new internal review roots: `05_BUSINESS/Administration/Draft_Reviews`.
