# Technical Content Production Agent: scoped runtime
...
- Exact agent ID: `c2d8893d-0abc-45b4-bbd0-2f2810c26dab`.
- Own guidance folder / report source_agent: `Blog_Website_Content_Creator`.
- Candidate source roots (each still requires explicit human source scope): `06_MARKETING/`, `08_PROJECTS/`, `10_REFERENCE/`, `06_MARKETING/Content/Draft_Reviews/`.
- Approved-plan new internal review roots: `06_MARKETING/Content/Draft_Reviews`.
