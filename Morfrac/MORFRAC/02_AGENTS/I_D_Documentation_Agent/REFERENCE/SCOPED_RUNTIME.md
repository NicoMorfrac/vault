# I+D Documentation Agent: scoped runtime
...
- Exact agent ID: `15a8db35-6ad5-4311-a257-4e1d93b9ddcd`.
- Own guidance folder / report source_agent: `I_D_Documentation_Agent`.
- Candidate source roots (each still requires explicit human source scope): `04_ENGINEERING/`, `08_PROJECTS/`, `10_REFERENCE/`, `04_ENGINEERING/R&D/Reviews/`.
- Approved-plan new internal review roots: `04_ENGINEERING/R&D/Reviews`.
