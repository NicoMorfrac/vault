...
echo STEP 15 - Contextual Link Recommendations
py seo_contextual_link_recommender.py

echo.
echo STEP 16 - Search Console Merge Analysis
py seo_search_console_merge.py

echo.
echo STEP 17 - Executive SEO Review
py seo_executive_review.py

echo.
echo STEP 18 - Historical SEO Comparison
