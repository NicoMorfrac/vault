...
- Handoffs contain exact source IDs, requested decision, blockers, return format, originating issue and permitted recipients. Do not create a duplicate handoff; inspect existing authorised dependencies first. A delegated dependency remains open until evidence returns.
