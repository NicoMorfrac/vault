...
- undocumented legacy installations
- hidden reinforcement
- inaccessible backing structure
- uncertain geometry
- uncertain load paths
- buried metal and hidden corrosion
- poor retrofit documentation
- model-specific installation variance
...
- exploratory retrofit work
- installation delays
- excessive troubleshooting
- destructive inspection requirements
- overbuilding due to uncertainty
- installer liability transfer
- scope expansion after disassembly
...
- buyers experience high uncertainty before retrofit work begins
