# B2C Product Discovery Agent: scoped runtime
...
- Exact agent ID: `84b6f590-ae40-4066-bfbe-821c93df92d5`.
- Own guidance folder / report source_agent: `STRATEGIC/B2C_PRODUCT_DISCOVERY`.
- Candidate source roots (each still requires explicit human source scope): `05_BUSINESS/Strategy/`, `05_BUSINESS/Accounting/Reviews/`, `06_MARKETING/`, `08_PROJECTS/`, `10_REFERENCE/`, `05_BUSINESS/Market_Intelligence/B2C_Reviews/`.
- Approved-plan new internal review roots: `05_BUSINESS/Market_Intelligence/B2C_Reviews`.
- Leadership workplan tools: not available.
- Public web research: available for public information only.
