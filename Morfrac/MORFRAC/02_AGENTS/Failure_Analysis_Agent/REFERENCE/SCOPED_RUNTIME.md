# Failure Analysis Agent: scoped runtime
...
- Exact agent ID: `20b3663f-b102-42c4-b557-d5b8f0977359`.
- Own guidance folder / report source_agent: `Failure_Analysis_Agent`.
- Candidate source roots (each still requires explicit human source scope): `04_ENGINEERING/`, `08_PROJECTS/`, `10_REFERENCE/`, `04_ENGINEERING/Failure_Analysis/Reviews/`.
- Approved-plan new internal review roots: `04_ENGINEERING/Failure_Analysis/Reviews`.
