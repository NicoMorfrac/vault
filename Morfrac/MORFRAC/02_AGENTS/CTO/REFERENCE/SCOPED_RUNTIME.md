...
- Exact agent ID: `ffe90aa4-5f80-4b93-8eba-22d5bc836764`.
- Own guidance folder / report source_agent: `CTO`.
- Candidate source roots (each still requires explicit human source scope): `04_ENGINEERING/`, `08_PROJECTS/`, `10_REFERENCE/`, `04_ENGINEERING/Technical_Management/Reviews/`.
- Approved-plan new internal review roots: `04_ENGINEERING/Technical_Management/Reviews`.
