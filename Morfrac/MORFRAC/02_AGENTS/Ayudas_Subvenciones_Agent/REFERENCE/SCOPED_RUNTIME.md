# Ayudas y Subvenciones Agent: scoped runtime
...
- Exact agent ID: `8201334b-1302-4a73-9a46-dd2d62a4a124`.
- Own guidance folder / report source_agent: `Ayudas_Subvenciones_Agent`.
- Candidate source roots (each still requires explicit human source scope): `05_BUSINESS/Public_Funding/`, `04_ENGINEERING/R&D/`, `08_PROJECTS/`, `10_REFERENCE/`, `05_BUSINESS/Public_Funding/Reviews/`.
- Approved-plan new internal review roots: `05_BUSINESS/Public_Funding/Reviews`.
