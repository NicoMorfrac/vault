# Production & Workshop Coordinator: scoped runtime
...
- Exact agent ID: `2b31d6d9-5d51-4d7a-b922-4783660fcba4`.
- Own guidance folder / report source_agent: `Production_Workshop_Coordinator`.
- Candidate source roots (each still requires explicit human source scope): `04_ENGINEERING/`, `08_PROJECTS/`, `10_REFERENCE/`, `04_ENGINEERING/Workshop/Reviews/`.
- Approved-plan new internal review roots: `04_ENGINEERING/Workshop/Reviews`.
- Leadership workplan tools: not available.
...
- Existing connector retained: `workshop_scoped` for its original bounded workflow; use org_scoped for the new review/workplan features.
