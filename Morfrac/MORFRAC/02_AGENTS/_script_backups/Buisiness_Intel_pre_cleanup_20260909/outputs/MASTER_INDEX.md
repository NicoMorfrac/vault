...
| Report | Date | Classification | Status | Confidence |
|---|---|---|---|---|
...
|---|---|---|---|
| [[2026-05-24_MORAAAAA-87_Retrofit_Load_Path_Strategic_Synthesis]] | 2026-05-24 | MORAAAAA-87 Strategic Synthesis: Retrofit Load-Path Uncertainty and Rigging/Deck Hardware Integration | STRATEGIC_OPPORTUNITY |
| [[Weekly_Report_Template]] |  | Business Intel Weekly Report: YYYY-MM-DD | UNREVIEWED |

---

## RAW FINDINGS

| Finding | Date | Classification | Status | Confidence |
|---|---|---|---|---|
| [[Raw_Finding_Template]] |  | UNCLASSIFIED | UNREVIEWED | HIGH |

---

## CANONICAL BUSINESS COPIES

| Report | Folder | Date | Classification | Status |
|---|---|---|---|---|
