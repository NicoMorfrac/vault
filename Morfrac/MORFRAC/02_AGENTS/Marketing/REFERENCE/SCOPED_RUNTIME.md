...
- Exact agent ID: `02e3c568-a7d9-4ae6-a2a1-5ff17ecac41f`.
- Own guidance folder / report source_agent: `Marketing`.
- Candidate source roots (each still requires explicit human source scope): `06_MARKETING/`, `08_PROJECTS/`, `10_REFERENCE/`, `06_MARKETING/Management/Reviews/`.
- Approved-plan new internal review roots: `06_MARKETING/Management/Reviews`.
- Leadership workplan tools: available, human approval required.
- Public web research: available for public information only.
- Marketing analytics: scoped read helper prepared; verify the live connection on an authorised task.
